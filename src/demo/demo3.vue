 ...
 * @LastEditTime: 2024-09-09 08:55:35
...
<template>
  ...
  <VueEchartsLinkage ref="echartsLinkageRef" :cols="1" :echarts-max-count="10" :echarts-colors="['red', 'blue', 'green', 'yellow', 'goldenrod', 'skyblue']" @drop-echart="dropEchart" />
</template>
